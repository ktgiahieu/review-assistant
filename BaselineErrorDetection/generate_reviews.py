...
def process_markdown_file(
    ...
    try:
        ...
        # Construct the prompt using the single comprehensive persona
        ...
        output_json_file_path = Path(output_base_dir) / unique_paper_identifier / f"{unique_paper_identifier}_review.json"
