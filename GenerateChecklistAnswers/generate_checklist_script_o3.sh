...
python generate_checklistanswers_with_separate_prompts.py --input_dir data/ICLR2024_latest/accepted --output_dir checklists/o3/ICLR2024/accepted --file_pattern "./*/structured_paper_output/paper.md" --max_workers 200 --deployment_name Checklist-GPT-o3 --debug_timer
