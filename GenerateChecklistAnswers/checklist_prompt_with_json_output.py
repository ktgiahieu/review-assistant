...
Your response MUST be a single, valid JSON object that conforms to the schema provided below. Do not include any text, markdown, or code formatting before or after the JSON object.
...
The JSON output should follow this structure:
{
  ...
  "paper_link": "The full https://openreview.net link",
  "formatted_abstract": {
      ...
      "items": [
        {
          ...
          "answer": "Yes",
          "reasoning": "The paper discusses positive impacts in the 'Societal Impact' section on page 8."
        },
        // ... more items for this section
      ]
    },
    // ... other sections like "B. Contribution", "C. Soundness", "D. Presentation"
  ]
}
"""
    ...
    def generate_prompt_for_paper(paper: str) -> str:
        ...
        """
        paper_and_checklist_content = """Below are full content of checklists:
A. Compliance
{compliance_list}
B. Contribution
{contribution_list}
...
{paper}
END OF PROVIDED CONFERENCE PAPER""".format(
        ...
        return ChecklistPrompt.prompt + paper_and_checklist_content
